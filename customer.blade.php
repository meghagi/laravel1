  ...
  <nav class="navbar navbar-expand bg-dark navbar-dark" id="nav1">
    <div class="container-fluid">
        <ul class="navbar-nav">
            ...
            <li class="nav-item" id="hm">
                <a class="nav-link ms-3 active" href="{{url('/customer/view/{id}')}}">Customerview</a>
            </li>
            <li class="nav-item" id="hm">
...
<center>
  <form action="{{route('update')}}" name="myForm" method="post" onsubmit="return validateForm()"  enctype="multipart/form-data">
    @csrf
...
<div class="form-group">
  ...
  <div class="col-sm-6">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="Pwd" placeholder="Enter password" name="Password"value="{{$customer->password}}">
      <span class="text-danger">
        @error('Password')
            {{$message}}
  ...
  <div class="col-sm-6">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="CPwd" placeholder="Enter password" name="CPassword"value="{{$customer->password}}">
      <span class="text-danger">
        @error('Password')
            {{$message}}
