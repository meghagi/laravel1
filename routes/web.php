...
Route::post('/reg/{id}',[Customercontroller::class,'store'])->name('registration');
Route::get('/reg3',[Customercontroller::class,'abc']);
...
Route::post('update1/{id}',[Customercontroller::class,'update1'])->name('update');
